...
void main() {
  ...
  test(
    'DiaryEntry can be associated with a Stop or an Activity and correctly saved',
    () async {
      ...
      // 2. Aggiunge un'Attività a quella tappa
      ...
      // 3. Aggiunge un Ricordo associato (alla Tappa)
      ...
      // 4. Aggiunge un Ricordo associato (all'Attività)
      ...
      // 5. Verifica che siano presenti in currentDiaryEntries con le associazioni intatte
      final entries = provider.currentDiaryEntries;
      expect(entries.length, 2);

      final retrievedStopMemory = entries.firstWhere(
        (e) => e.title == 'Amazing Colosseum Visit',
      );
      ...
      final retrievedActivityMemory = entries.firstWhere(
        (e) => e.title == 'Felt like a Gladiator',
      );
